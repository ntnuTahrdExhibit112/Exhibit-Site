...
<section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4 mt-5 justify-content-center" data-aos="zoom-in" data-aos-delay="250">
            <div class="col-xl-2 col-md-4"> <a href="#about">
                <div class="icon-box"> <i class="bi bi-info-circle"></i>
                    <h3>關於科技系</h3>
                </div>
                </a> </div>
            <div class="col-xl-2 col-md-4"> <a href="#concept">
            ...
            <div class="col-xl-2 col-md-4"> <a href="#visit">
                <div class="icon-box"> <i class="bi bi-map"></i>
                    <h3>參觀資訊</h3>
                </div>
                </a> </div>
            <div class="col-xl-2 col-md-4"> <a href="#contact">
...
<main id="main"> 
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row"> <!--歷史沿革-->
                <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100"> <img src="https://static.wixstatic.com/media/bd5b11_f46149f57ff84d3eb8f75746dc073125~mv2.jpg/v1/fill/w_828,h_522,al_c,q_85,usm_0.66_1.00_0.01,enc_auto/bd5b11_f46149f57ff84d3eb8f75746dc073125~mv2.jpg" class="img-fluid" alt=""> </div>
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                    <h3>歷史沿革</h3>
                    <p class="fst-italic p-5"> 本系根源於民國42年所成立的工業教育系「工藝教育組」，專責培育我國中學「工藝」課程之師資，配合課程內涵之調整與修訂，在民國61年更名為「工業技術教育組」，並於民國71年正式獨立設系為「工藝教育學系」，為配合學校藝術學院成立，本系隸屬於藝術學院。 <br>
                        民國80年增設碩士班，民國87年增設博士班。隨著社會環境的變遷與課程改革的需求，外加上師資培育多元化的衝擊，在民國83年正式將系名更改為「工業科技教育學系」，專責培育中學「生活科技」課程之師資，民國87年本系改隸屬於當年新成立的科技學院。為符合本系培育科技產業教育訓練人才之目標，本系獲教育部同意，從98學年度起更名為「科技應用與人力資源發展學系」，並簡稱為科技系。 <br>
                        為拓展本系畢業學生之就業機會並開啟本系畢業生至業界就業的契機，本系自民國83年開始，以既有的師資培育為基礎，先後在「大學部」實施課程分組，目前的大學部課程則分為「學習與科技組」及「設計與科技組」，以培養科技產業界所須之人力資源人才。在「碩士班」階段則先後規劃「科技與工程教育」、「人力資源」與「網路學習」等多元之課程內涵，協助學生發展各該領域之專業與研究能力；在「博士班」則設有「科技與工程教育」與「人力資源」兩組課程，培育各該領域之專業「教學」與「研究」之人才。 </p>
                </div>
            </div>
            <div class="row"> <!--系所特色-->
                <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                    <center>
                        <img src="https://static.wixstatic.com/media/bd5b11_a4d3120f948c4658aa0c7d3b198d205a~mv2.png/v1/fill/w_384,h_456,al_c,lg_1,enc_auto/%E9%97%9C%E6%96%BC%E6%88%91%E5%80%913.png" class="img-fluid" alt="">
                    </center>
                </div>
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right" data-aos-delay="100">
                    <h3>系所特色</h3>
                    <p class="fst-italic p-5"> 科技系原屬培育中學「生活科技」教師之專門機構，然為因應師培市場之萎縮，科技系於十年前即著手調整課程結構，以培育學生朝向科技產業界發展為目標。 <br>
                        目前，科技系的課程本質，是以科技產業為主體，學生藉由各科技產業課程，例如傳播科技業、製造科技業、營建科技業、運輸科技業，來瞭解台灣科技社會的結構與內涵。在上課的型態上，則是提供學生以「設計」及「製作」的方式來進行，藉以深入瞭解科技產業之工作內涵與程序。 <br>
                        在此基礎之下，本系再輔以人力資源發展的專業課程，使學生具備「科技產業知識」及「人力資源發展專長」，得以進入科技產業從事企業的教育訓練工作。 </p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-delay="100">
                    <h3 class="p-3">專展設計理念</h3>
                    <p class="fst-italic p-5"> 本次主題為「技動」，臺師大科技系過去多培育生活科技老師，如今致力於轉型，以解決生活問題為主要設計走向，除了保留原來的專業傳統技藝外，也結合了電腦程式語言的軟體設計，嘗試將程式設計應用於產品設計之中，讓一套產品開發能做到「虛」、「實」兩層面兼具。<br>
                        而專展名稱「技動」，取自悸動，代表著一個作品帶給人的內心感受與心動，也代表著科技系動手製造的 maker 精神。不只是心中的感動，而是技藝與記憶交織而成的期待與憧憬，就像是每個人心中，躲藏在心底深處的夢想，藉著這個機會，讓沈默的夢想繼續悸動。 </p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="visit" class="contact">
        <div class="container" data-aos="fade-up">
                    ...
                    <div class="info">
                        ...
                        <div class="traffic"> <i class="bi bi-stoplights"></i>
                            ...
                            <p> 1. <b>捷運古亭站</b>：中和新蘆線〈橘線〉、松山新店線〈綠線〉於『古亭站』五號出口直行約八分鐘即可到達。<br>
                                ...
                                <br>
                                3. <b>捷運東門站</b>：淡水信義線〈紅線〉、中和新蘆線〈橘線〉於『東門站』五號出口，麗水街直行約十四分鐘即可到達。<br>
                                <br>
                            </p>
                        </div>
                    </div>
            ...
            <div>
                <iframe style="border:0; width: 100%; height: 60vh;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3615.212453793235!2d121.52710961494927!3d25.026863144731585!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3442a9844dba393d%3A0x1abfe37305dcc552!2zMTA25Y-w5YyX5biC5aSn5a6J5Y2A5ZKM5bmz5p2x6Lev5LiA5q61MTI5LTHomZ_ntpzlkIjlpKfmqJM!5e0!3m2!1szh-TW!2stw!4v1647934654439!5m2!1szh-TW!2stw" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
    </section>
    <!-- End Contact Section --> 
                ...
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member" data-aos="fade-up" data-aos-delay="100">
                        <div class="member-img"> <img src="assets/img/contact/William_Chang.png" class="img-fluid" alt="">
                            <div class="social"> <a href="#tel:"><i class="bi bi-phone-fill"></i></a> <a href="https://www.instagram.com/" target="_blank"><i class="bi bi-instagram"></i></a> </div>
                        </div>
                        <div class="member-info">
                            <h3>張子濰</h3>
                            <span><a href="#mailto" target="_blank">EMAIL</a></span> </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                    <div class="member" data-aos="fade-up" data-aos-delay="100">
